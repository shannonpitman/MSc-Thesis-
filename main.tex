...
\renewcommand{\author}{Shannon Pitman} % Author name
...
\providecommand{\listequationsname}{List of Equations}
\ifcsdef{myequations}{}{%
...
\include{Chapters/literature_review} % Literature Review
\include{Chapters/methodology} % Methodology
\include{Chapters/results} % Results/Findings
\include{Chapters/discussion} % Discussion
\include{Chapters/conclusions} % Conclusions
\include{Chapters/recommendations} % Recommendations
