...
\usepackage[printonlyused]{acronym} % Include a list of acronyms (no page numbers in the list)
...
\usepackage{csquotes}
\usepackage[british]{babel} % Characters from British English Support
...
\usepackage{setspace}   % Management of line spacing
\usepackage{xspace}     % Define commands that appear not to eat spaces
\usepackage{xcolor}     % Driver-independent color extensions
\usepackage{geometry}   % Customize document dimensions
...
% Mathematics
\usepackage{mathtools}  % Extension of amsmath, provides additional math tools
...
\usepackage[labelfont=bf,justification=centering,footnotesize]{caption} % Captions
\usepackage{subcaption} % Support for sub-captions
\usepackage{pdfpages}   % Include PDF documents
\usepackage{placeins}   % Keep floating objects in their place

% Algorithims
\usepackage[ruled]{algorithm2e} % Algorithm environment
...
\usepackage[bookmarksopen=true,
		...
		pdfusetitle,
		hidelinks]{hyperref}   % Extensive support for hypertext
...
\renewcommand{\chapnamefont}{\fontsize{25}{25}\selectfont}
\renewcommand{\chapnumfont}{\chapnamefont}
\renewcommand{\chaptitlefont}{\chapnamefont}
\renewcommand{\printchapternum}{}
\renewcommand{\afterchapternum}{}
\renewcommand{\printchaptername}{}
\renewcommand{\afterchaptertitle}{\chapnumfont\hfill\thechapter\\\vspace*{-.3cm}\hrulefill\vspace*{1.5cm}\\}
}
\makeatother
...
%----------------------------------------------------------------------------------------
\setsecheadstyle{\chapnamefont\fontsize{11}{14}\selectfont\bfseries}
\setsubsecheadstyle{\chapnamefont\fontsize{11}{14}\selectfont\bfseries}
\setsubsubsecheadstyle{\chapnamefont\fontsize{11}{14}\selectfont\bfseries}


% Set section font to EB Garamond 12 All SC using memoir class commands
% \setsecheadstyle{\fontspec{EB Garamond 12 All SC}\fontsize{12}{14}\selectfont}
% \setsubsecheadstyle{\fontspec{EB Garamond 12 All SC}\fontsize{12}{14}\selectfont}
% \setsubsubsecheadstyle{\fontspec{EB Garamond 12 All SC}\fontsize{12}{14}\selectfont}
